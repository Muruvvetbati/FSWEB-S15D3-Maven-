...
public class Main {
    ...
    public static void main(String[] args) {
       /* List<Employee> employees = new ArrayList<>();
        employees.add(new Employee(1,"muru","batı"));
        employees.add(new Employee(1,"muru","batı"));
        employees.add(new Employee(1,"muru","batı"));
        employees.add(new Employee(2,"yasemin","batı"));
        employees.add(new Employee(2,"yasemin","batı"));
        employees.add(new Employee(3,"merve","batı"));
        employees.add(new Employee(4,"ebru","karadayı"));
        employees.add(new Employee(5,"fatma","karaduman"));
